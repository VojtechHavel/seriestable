...
import com.seriestable.social.google.connect.GoogleConnectionFactory;
 ...
 */
@Configuration
@ConditionalOnClass({SocialConfigurerAdapter.class, com.seriestable.social.google.connect.GoogleConnectionFactory.class})
...
public class GoogleAutoConfiguration {
  ...
  @Configuration
  @EnableSocial
  @EnableConfigurationProperties(com.seriestable.social.google.config.boot.GoogleProperties.class)
  ...
  protected static class GoogleConfigurerAdapter extends SocialConfigurerAdapter {
    ...
    public void addConnectionFactories(final ConnectionFactoryConfigurer configurer, final Environment environment) {
      final com.seriestable.social.google.connect.GoogleConnectionFactory factory =
