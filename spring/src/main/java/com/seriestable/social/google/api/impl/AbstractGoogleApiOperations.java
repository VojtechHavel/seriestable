...
import com.seriestable.social.google.api.ApiEntity;
...
public abstract class AbstractGoogleApiOperations {
  ...
  protected <T extends com.seriestable.social.google.api.ApiEntity> T saveEntity(final String baseUrl, final T entity) {
