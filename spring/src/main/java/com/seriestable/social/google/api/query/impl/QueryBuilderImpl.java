...
/**
 * Abstract superclass for {@link com.seriestable.social.google.api.query.QueryBuilder} implementations.
 * @author Gabriel Axel
 * @param <Q> {@link com.seriestable.social.google.api.query.QueryBuilder} type
 * @param <T> Model type
 */
public abstract class QueryBuilderImpl<Q extends com.seriestable.social.google.api.query.QueryBuilder<?, T>, T> implements QueryBuilder<Q, T> {
